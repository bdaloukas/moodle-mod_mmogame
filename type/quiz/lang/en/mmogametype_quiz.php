...
$string['privacy:metadata:mmogame_grades:fraction'] = 'fraction';
$string['privacy:metadata:mmogame_grades:iscorrect'] = 'iscorrect';
$string['privacy:metadata:mmogame_grades:iscorrect2'] = 'iscorrect2';
$string['privacy:metadata:mmogame_grades:layout'] = 'layout';
$string['privacy:metadata:mmogame_grades:mmogame'] = 'The mmoGame activity';
$string['privacy:metadata:mmogame_grades:numattempt'] = 'The number of attempt';
...
$string['privacy:metadata:mmogame_grades:queryid'] = 'queryid';
$string['privacy:metadata:mmogame_grades:score'] = 'score';
$string['privacy:metadata:mmogame_grades:score2'] = 'score2';
$string['privacy:metadata:mmogame_grades:timeanswer'] = 'timeanswer';
$string['privacy:metadata:mmogame_grades:timeclose'] = 'timeclose';
$string['privacy:metadata:mmogame_grades:timestart'] = 'timestart';
$string['privacy:metadata:mmogame_grades:useranswer'] = 'useranswer';
$string['privacy:metadata:mmogame_grades:useranswerid'] = 'useranswerid';
