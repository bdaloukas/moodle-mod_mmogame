...
$string['algorithm'] = 'Algorithm for selecting questions';
$string['alone_state1'] = 'Playing the game';
$string['idea'] = 'Idea';
$string['js_add_grade'] = 'Grades from last question';
...
$string['js_alone_help'] = 'For a question with n possible answers, a correct answer gives n−1 points, while a wrong answer deducts 1 point. For example, with 4 answers, a correct answer gives 3 points and a wrong answer deducts 1 point.';
...
$string['js_position_opponent'] = 'Opponent\'s position';
...
$string['mode_aduel'] = 'Quiz - ADuel';
$string['mode_alone'] = 'Quiz - Alone';
$string['mode_split'] = 'Quiz - Split';
$string['pluginname'] = 'MMOGame Quiz';
$string['privacy:metadata:mmogame_quiz_attempt:iscorrect'] = 'iscorrect';
$string['privacy:metadata:mmogame_quiz_attempt:layout'] = 'layout';
$string['privacy:metadata:mmogame_quiz_attempt:numattempt'] = 'numattempt';
$string['privacy:metadata:mmogame_quiz_attempt:numteam'] = 'numteam';
$string['privacy:metadata:mmogame_quiz_attempt:queryid'] = 'queryid';
$string['privacy:metadata:mmogame_quiz_attempt:timeanswer'] = 'timeanswer';
$string['privacy:metadata:mmogame_quiz_attempt:timeclose'] = 'timeclose';
$string['privacy:metadata:mmogame_quiz_attempt:timestart'] = 'timestart';
...
$string['split_state1'] = 'Playing the game';
$string['split_state2'] = 'Show stats';
